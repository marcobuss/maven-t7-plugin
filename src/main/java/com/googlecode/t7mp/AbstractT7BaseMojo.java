...
public abstract class AbstractT7BaseMojo extends AbstractMojo {
	...
	/**
	 * If set to <code>true</code> the maven process will be halted after
	 * starting tomcat.
	 * <p/>
	 * For integration testing set this property to <code>false</code> or the
	 * maven run will ever be finished.
	 * 
	...
	/**
	 * If set to <code>true</code> Plugin logging will be enabled. Usefull to
	 * see details about dependency resolving.
	 * 
	...
	/**
	 * Sets the tomcat version to use. All available versions can be found <a
	 * href="http://search.maven.org/#browse|-712236355">here</a>.
	 * 
	...
	/**
	 * Defining the tomcat listening port. This value will be written to the
	 * generated catalina.properties as <code>http.port</code>
	 * 
	...
	/**
	 * 
	 * @parameter expression="${t7.tomcatShutdownCommand}"
	...
	/**
	 * 
	 * @parameter expression="${t7.tomcatShutdownHost}"
	...
	/**
	 * 
	 * @parameter expression="${t7.tomcatConfigDirectory}"
	 *            default-value="${basedir}/src/main/tomcat/conf"
	 * @optional
	 * 
	 */
	...
	/**
	 * 
	 * @parameter expression="${t7.contextPath}"
